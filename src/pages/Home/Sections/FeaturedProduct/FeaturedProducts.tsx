      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <NavLink to="/products/featured">
            <button className="btn btn-outline px-3 text-[12px] lg:px-6 rounded-full border border-[#141414] text-[#020202] hover:bg-black hover:text-white transition duration-300">
              SEE ALL PRODUCTS
            </button>
          </NavLink>
        </div>
